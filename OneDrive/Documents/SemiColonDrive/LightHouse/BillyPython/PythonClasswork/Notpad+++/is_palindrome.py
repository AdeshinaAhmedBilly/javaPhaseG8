...
class TestPalindrome(unittest.TestCase):
    ...
    def test_with_different_types(self):
        ...
        self.assertTrue(is_palindrome(12321))  # Integer input
        self.assertTrue(is_palindrome("12321"))  # String input

if __name__ == "__main__":
    # If run as script, execute main()
    # If you want to run tests, comment out main() and uncomment unittest.main()
    main()
    # unittest.main()